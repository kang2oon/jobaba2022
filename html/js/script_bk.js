$(document).ready(function(){
	...
	$('.hb_menu').click(function(){
		...
		if(dw <= 767){
			//console.log('mobile');
			$('.gnb-inner-wrap.gnb_wrapper').addClass('show');
			$('.all_menu').show();
		} else {
			//console.log('pc');
...
/*
	//�대뜑 寃��됱갹 諛곕꼫 - 湲곕뒫�ㅻ쪟濡� �뺤씤�� 諛섏쁺
//	var bnr_box = new Swiper('.bnr_box', {
//		slidesPerView: 1,
//		loop: true,
//		pagination: {
//			el: '.swiper-pagination',
...
//	});
	...
	//理쒓렐 蹂� �뺣낫 諛곕꼫 - 湲곕뒫�ㅻ쪟濡� �뺤씤�� 諛섏쁺
//	var last_bnr = new Swiper('.last_banner', {
//		spaceBetween: 10,
//		loop: true,
//		pagination: {
//			el: '.swiper-pagination',
...
//	$('.quick').fixedsticky();
	...
	/*$('.f_info_area').click(function(){
		$('.f_info_area .mf_sign').toggleClass('open');
		$('.footer_num_area .f_info').toggle();
	});*/
	...
	/*var checkboxs = $('input[type=checkbox]');
	  ...
	  checkboxs.change(function(){
	    if($(this).is(':checked')){
	     $(this).parent().parent().addClass('customCheckboxChecked');
	     $(this).attr('checked','checked');
	    } else {
	     $(this).parent().parent().removeClass('customCheckboxChecked');
